...
import com.dvinfosys.multiimagepicker.Adapter.AlbumPickerAdapter;
...
public class AlbumPickerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setView(findViewById(R.id.layout_album_picker));
        ...
        progressBar = (ProgressBar) findViewById(R.id.pb_album_picker);
        gridView = (GridView) findViewById(R.id.gv_album_picker);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case Constants.FETCH_COMPLETED: {
                        if (adapter == null) {
                            adapter = new AlbumPickerAdapter(getApplicationContext(), albums);
